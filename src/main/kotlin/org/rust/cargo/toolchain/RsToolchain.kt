...
abstract class RsToolchain(val location: Path) {
    ...
    open fun pathToExecutable(toolName: String): Path = location.pathToExecutable(toolName)
    ...
    open fun hasExecutable(exec: String): Boolean = location.hasExecutable(exec)
